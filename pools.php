...
$pools = $proxmox->get('/pools');
foreach ($pools['data'] as $key => $data) {
    $poolsname[] = array('name' => $data['name']);
    $poolsstatus[] = array('status' => $data['status']);
    $poolscpu[] = array('cpu' => $data['cpu']);
}
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <td>Max Storage</td><td><?php echo $maxdisk[0]['maxdisk']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Max Memory</td><td><?php echo $maxmem[0]['maxmem']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Max Swap</td><td><?php echo $maxswap[0]['maxswap']; ?></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
